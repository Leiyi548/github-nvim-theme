...
theme.setup = function(cfg)
  ...
  hi.plugins = {
    ...
    markdownBold = { fg = c.syntax.param, style = Styles.Bold },
    htmlBold = { fg = c.syntax.param, style = Styles.Bold },
    ...
    NvimTreeRootFolder = { fg = c.blue, style = Styles.BoldItalic },
    ...
    CmpItemAbbrMatch = { fg = c.blue, sytle = 'bold' },
    ...
    CmpItemKindKeyWord = { fg = c.syntax.string },
    CmpItemKindText = { fg = c.syntax.string },
